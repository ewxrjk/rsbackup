...
int main() {
  ...
  assert(d.toNumber()
         == (1997 * 365 + (1997 / 4) - (1997 / 100) + (1997 / 400) + 31 + 28 + 2
             - 1));
  Date dd(d.toTime());
  ...
  assert(e.toNumber()
         == (1998 * 365 + (1997 / 4) - (1997 / 100) + (1997 / 400) + 31 + 28 + 2
             - 1));
  assert(e - d == 365);
  Date ee(e.toTime());
  ...
  static const struct {
    const char *before, *after;
      ...
      {"1995-01-01", "1995-01-02"}, {"1995-01-31", "1995-02-01"},
      {"1995-02-28", "1995-03-01"}, {"1995-12-31", "1996-01-01"},
      {"1996-02-28", "1996-02-29"}, {"1996-02-29", "1996-03-01"},
  };
  for(auto &t: day_increment_tests) {
    d = t.before;
    assert(d.toString() == t.before);
    ++d;
    printf("%s:%d: %s %s %s\n", __FILE__, __LINE__, t.before, t.after,
           d.toString().c_str());
  ...
  static const struct {
    const char *before, *after;
      ...
      {"1995-01-01", "1995-02-01"}, {"1995-01-31", "1995-02-28"},
      {"1995-02-28", "1995-03-28"}, {"1995-12-31", "1996-01-31"},
      {"1996-01-28", "1996-02-28"}, {"1996-01-29", "1996-02-29"},
      {"1996-01-30", "1996-02-29"}, {"1996-02-28", "1996-03-28"},
